...
public abstract interface ConfigurationSection
{
  ...
  public abstract void setComment(String paramString, String... paramVarArgs);
  
  public abstract Map<String, String> getComments(boolean paramBoolean);
  
  public abstract void setComments(Map<String, String> paramMap);
}


/* Location:           C:\Users\Dylan\Desktop\BungeeYAML.jar
 * Qualified Name:     net.craftminecraft.bungee.bungeeyaml.bukkitapi.ConfigurationSection
